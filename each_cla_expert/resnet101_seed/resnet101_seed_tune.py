...
from resnet101_seed_train import (
...
BEST_MODEL_PATH = "base_seed42/best.epoch"
...
def eval_dir(image_dir, thresholds, model, device):
    """Evaluate on image_dir with thresholds vector; return y_true, y_pred."""
...
if __name__ == "__main__":
    ...
    # Save test-set raw sigmoid probabilities to JSON
    ...
    # Save validation-set raw sigmoid probabilities to JSON
